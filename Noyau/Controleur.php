...
{
    // Tableaux contenant les differentes pieces de l'url
    // exemple : /test/hello/reste ---> $_A_urlDecortique['controleur'] est égale à "ControleurTest"
    //                                  $_A_urlDecortique['action'] est égale à "helloAction"
    private $_A_urlDecortique;
    // le reste des urls -> $_A_urlParametres[0] = "reste"
    ...
    public function __construct ($S_url, $A_postParams)
    {
        ...
        if (empty($A_urlDecortique[0])) {
            ...
            $A_urlDecortique[0] = 'ControleurGrouping';
        } else {
